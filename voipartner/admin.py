...
class ContratoAdmin(admin.ModelAdmin):
    ...
    fields = ( 'no_contrato','usuario','status','data_inicio_vigencia','dia_aniversario', 'data_fim_adesao', 'data_renovacao_automatica', 'cotas_liberadas', 'cotas_contratadas', 'valor_cota', 'comprovante_deposito', 'link_contrato', 'contrato_assinado', 'observacao', 'percentual_lucro_mensal',)
